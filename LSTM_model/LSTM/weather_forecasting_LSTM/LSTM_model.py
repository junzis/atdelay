...
dataset = read_csv(r'LSTM_model\LSTM\weather_forecasting_LSTM\raw.csv',  parse_dates = [['year', 'month', 'day', 'hour']], index_col=0, date_parser=parse)
...
reframed = series_to_supervised(scaled, n_in=number_of_time_steps, n_out=1)
