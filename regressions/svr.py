...
from tools import parameter_search
from tools import filtering_data_onehot
...
model_parameters = {
    "KNearestNeighbor": {"n_neighbors": range(1, 70, 10), "weights": ["uniform"]},
    "SVM": {
        "C": [0.1, 1, 10, 100, 1000],
...
predictions = {}
filtering_data_onehot(
    "./LRData/LRDATA.csv", datetime(2019, 3, 1), datetime(2019, 12, 31), "EGLL", True
)
print("reading data...")
...
best_parameters, prediction, y_test = parameter_search(
    models["KNearestNeighbor"],
    model_parameters["KNearestNeighbor"],
    X,
    Y,
